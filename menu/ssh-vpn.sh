...
organizationalunit=klmpk
commonname=none
email=klmpk@azigaming404.com

# simple password minimal
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/Andyyuda/lamar/main/Insshws/password.txt"
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Andyyuda/lamar/main/configuration/nginx.conf"
...
cd
cd
wget -O /usr/bin/badvpn-udpgw https://raw.githubusercontent.com/Andyyuda/lamar/main/udpgw/badvpn-udpgw && chmod +x  /usr/bin/badvpn-udpgw
#system badvpn 7300
wget -O /etc/systemd/system/svr-7300.service https://raw.githubusercontent.com/Andyyuda/lamar/main/udpgw/svr-7300.service && chmod +x  /etc/systemd/system/svr-7300.service
#system badvpn 7200
wget -O /etc/systemd/system/svr-7200.service https://raw.githubusercontent.com/Andyyuda/lamar/main/udpgw/svr-7200.service && chmod +x  /etc/systemd/system/svr-7200.service
#system badvpn 7100
wget -O /etc/systemd/system/svr-7100.service https://raw.githubusercontent.com/Andyyuda/lamar/main/udpgw/svr-7100.service && chmod +x  /etc/systemd/system/svr-7100.service
...
wget https://raw.githubusercontent.com/Andyyuda/lamar/main/scurity/rules.zip
unzip rules.zip
...
echo; echo 'Installing DDOS-protevtion v.10 by klmpk'; echo
...
wget -q -O /etc/klmpk.me "https://raw.githubusercontent.com/Andyyuda/lamar/main/issue.net"
chmod +x /etc/klmpk.me
echo "Banner /etc/klmpk.me" >> /etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/klmpk.me"@g' /etc/default/dropbear


#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/Andyyuda/lamar/main/Insshws/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
mkdir /etc/klmpk/
mkdir /etc/klmpk/limit/
mkdir /etc/klmpk/limit/vmess
mkdir /etc/klmpk/limit/trojan
mkdir /etc/klmpk/limit/vless
mkdir /etc/klmpk/limit/vmess/ip
mkdir /etc/klmpk/limit/trojan/ip
mkdir /etc/klmpk/limit/vless/ip
mkdir /tmp/vless/
mkdir /tmp/vmess/
mkdir /tmp/trojan/
